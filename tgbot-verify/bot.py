...
from handlers.verify_commands import (
    ...
    getV4Code_command,
    verify6_command,
    scrape_veterans_command,
    bulk_verify6_command,
)
...
def main():
    ...
    application.add_handler(CommandHandler("scrape_veterans", partial(scrape_veterans_command, db=db)))
    application.add_handler(CommandHandler("bulk_verify6", partial(bulk_verify6_command, db=db)))
